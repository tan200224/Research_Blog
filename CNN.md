...
Convolutional Nerual Network uses fileter to extract fetures from differnt partrs of image. 
...
* So the first 'Function' is the image that is combnined with the kenrel or Filter, which produces a Feature Map
...
## Image Features
* Our feature maps are actually Feature Detecors
* Why did we do this?
...
In the past a lot of features are hand crafted, which is very ahrd messy and leads to often poor result. CNN solved this by having the ability to learn Features.
